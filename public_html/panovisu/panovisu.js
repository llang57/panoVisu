    ...
    $(document).on("click", ".hotSpots", function () {
        ...
        switch (pointsInteret[numHS].type) {
            ...
            case "image" :
                ...
                break;
            case "html" :
                afficheHTML(pointsInteret[numHS].contenu, pointsInteret[numHS].largeur, pointsInteret[numHS].position);
                break;
        }
    });
...
//
    ...
    function afficheHTML(url, taille, position) {
        taille = taille || "";
        ...
        $.get(xmlFile,
                function (d) {
                    ...
                    $(d).find('point').each(function () {
                        ...
                        pointsInteret[i].largeur = $(this).attr('taille') || "";
                        pointsInteret[i].position = $(this).attr('position') || "center";
                        i++;
                    });
                    /*
                     * 
